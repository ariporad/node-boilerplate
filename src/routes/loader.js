...
module.exports = exports = function (app, express, server, dir) {
	...
	for (var i = 0; i < modules.length; i++) {
		...
		// This is a bit complicated. I wanted to allow the modules to export
		// other things as well, So what I did was to default to using
		// `exports[get/put/post/delete]` as routes, and everything else as
		// whatever. But then I deided to add something so that a module could
		// use all of the other ~25 HTTP verbs express supports. So they can
		// optionaly export a exports.verbs array, which contains a list of
		// verbs that they would like to be added as well.
